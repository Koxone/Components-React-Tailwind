...
const CardFrostedGlassHoverExpand = () => {
  return (
    <div className="group relative h-64 w-80 overflow-hidden rounded-xl border border-white/10 bg-white/10 backdrop-blur-md transition-all duration-500 hover:scale-105 hover:bg-white/20">
