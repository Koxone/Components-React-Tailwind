...
const Card3DTiltWithShadow = () => {
  return (
    <div className="relative h-64 w-80 rounded-xl bg-gradient-to-r from-purple-500 to-indigo-500 shadow-2xl transition-transform duration-500 hover:rotate-3 hover:scale-105">
