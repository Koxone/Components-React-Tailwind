...
export default function DropdownParallax() {
  ...
  return (
    ...
    >
      ...
      <ul
        className={`absolute left-0 mt-2 w-44 transform divide-y divide-gray-100 rounded bg-white bg-fixed shadow-lg transition-all duration-600 ease-out ${menuClass}`}
      >
