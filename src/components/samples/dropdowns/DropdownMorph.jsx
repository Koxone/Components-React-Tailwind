...
export default function DropdownMorph() {
  ...
  const menuClass = open
    ? "rounded-xl scale-100 opacity-100"
    : "rounded-full scale-75 opacity-0 pointer-events-none";
  ...
  return (
    ...
    >
      ...
      <ul
        className={`absolute left-0 mt-2 w-44 transform divide-y divide-gray-100 bg-white shadow-lg transition-all duration-600 ease-in-out ${menuClass}`}
      >
