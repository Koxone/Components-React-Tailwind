...
function CategoriesSideBar() {
  return (
    <aside className="col-span-1 hidden max-h-full min-h-[calc(100vh-4rem)] max-w-[250px] flex-1 overflow-y-auto rounded-lg border border-gray-200 bg-gray-50 p-5 lg:block dark:border-gray-700 dark:bg-gray-800">
      <div className="mb-5">
      ...
      <div>
        <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          incidunt excepturi ratione voluptate quasi error vero nihil omnis est.
          Voluptates praesentium tenetur laudantium, eveniet eius velit
          reiciendis ex soluta?
        </p>
