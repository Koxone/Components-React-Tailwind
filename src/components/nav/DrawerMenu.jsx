    ...
    <AnimatePresence>
      {isToggle && (
        <motion.aside
          ...
          className="hide-scrollbar absolute z-50 col-span-1 flex h-[100dvh] max-w-[250px] flex-1 flex-col border-t-transparent bg-gray-50 p-5 pb-[400px] sm:hidden dark:border-gray-700 dark:bg-gray-800"
        >
